...
<div class="form" id="login">
	...
	<form action="login.php" method="POST">
		...
		<input class="input" type="password" name="Password" placeholder="Senha" required><br>
		<input class="button" type="submit" name="login" value="LOGIN"><br>
		<a id="oksignup">Assine aqui</a> | <a href="#">Esqueceu sua senha?</a>
	</form>
    </div>
</div>
<div class="form reg" id="signup">
	...
	<form action="login.php" method="POST">
		<input class="input" type="text" name="Username" placeholder="Username" required><br>
		<input class="input" type="password" name="Password" placeholder="Senha" required><br>
		<input class="input" type="password" name="ConfirmPassword" placeholder="Confirme a Senha" required><br>
		<input class="button" type="submit" name="signup" value="Cadastre-se"><br>
		<a id="oklogin">Entre aqui</a>
	</form>
    </div>
</div>
</div>
 <script
  src="http://code.jquery.com/jquery-3.3.1.min.js"a
